...
const ABI = require('../artifacts/contracts/Horse.sol/Horse.json');
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("Horse");
  const nft = await NFT.attach('0x7Cf297fAc2d025Efb56A7771523DfBd5521dF67e');
